...
needed by the Hopf comparison. The public long exact sequence package is kept
in a separate module so the signed transports remain hidden behind these
checked exactness theorems.
