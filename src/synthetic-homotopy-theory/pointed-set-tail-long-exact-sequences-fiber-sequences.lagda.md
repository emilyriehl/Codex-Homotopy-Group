...
```agda
module synthetic-homotopy-theory.pointed-set-tail-long-exact-sequences-fiber-sequences where
```
...
module _
  ...
  record Pointed-Set-Tail-Long-Exact-Sequence-Fiber-Sequence :
    UU (l1 ⊔ l2 ⊔ l3)
    where
    constructor
      make-Pointed-Set-Tail-Long-Exact-Sequence-Fiber-Sequence
    field
      ...
      is-exact-at-loop-base-pointed-set-tail-long-exact-sequence :
        is-exact-hom-Pointed-Set
          ...
          ( hom-loop-fibration-pointed-set-tail-long-exact-sequence)
          ( hom-boundary-pointed-set-tail-long-exact-sequence)
      is-exact-at-fiber-pointed-set-tail-long-exact-sequence :
        is-exact-hom-Pointed-Set
          ( trunc-Pointed-Set (Ω (base-fiber-sequence-Pointed-Type S)))
          ( trunc-Pointed-Set (fiber-fiber-sequence-Pointed-Type S))
          ( trunc-Pointed-Set (total-space-fiber-sequence-Pointed-Type S))
          ( hom-boundary-pointed-set-tail-long-exact-sequence)
          ( hom-fiber-inclusion-pointed-set-tail-long-exact-sequence)
      is-exact-at-total-space-pointed-set-tail-long-exact-sequence :
        is-exact-hom-Pointed-Set
          ( trunc-Pointed-Set (fiber-fiber-sequence-Pointed-Type S))
          ( trunc-Pointed-Set (total-space-fiber-sequence-Pointed-Type S))
          ( trunc-Pointed-Set (base-fiber-sequence-Pointed-Type S))
  ...
  open Pointed-Set-Tail-Long-Exact-Sequence-Fiber-Sequence
    public

  pointed-set-tail-long-exact-sequence-fiber-sequence :
    Pointed-Set-Tail-Long-Exact-Sequence-Fiber-Sequence
  pointed-set-tail-long-exact-sequence-fiber-sequence =
    make-Pointed-Set-Tail-Long-Exact-Sequence-Fiber-Sequence
