...
5. **Develop the Hopf construction and Hopf fibration.** The circle and
   ...
   homotopy, inverse-side left-composite homotopy, and retraction/section
   endpoint reductions for the associator inverse route, the bridge from
   `S^1 * S^1` to
   ...
   either by the remaining higher triangle coherences or by a pushout
   universal-property proof, then use
