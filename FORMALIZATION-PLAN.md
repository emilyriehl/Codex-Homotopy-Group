...
5. **Develop the Hopf construction and Hopf fibration.** The circle and
   ...
   glue computation laws, and conditional reductions from the remaining
   triangle-family extensions to the two-sided inverse homotopies, the bridge from
   `S^1 * S^1` to
   ...
   either by constructing the two remaining triangle-family extensions or by a
