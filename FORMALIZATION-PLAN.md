...
5. **Develop the Hopf construction and Hopf fibration.** The circle and
   ...
   `join-power 2 (Fin 2) * join-power 2 (Fin 2)`. The comparison between the
   family-induced flattened span and the explicit flattened descent span has
   checked vertex equivalences and the definitional left-leg square. Next,
   prove the right-leg meridian coherence, prove the associativity/join-power
