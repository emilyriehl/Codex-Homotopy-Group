...
| Long exact sequence of homotopy groups | Partial | Boundary maps, induced homomorphisms, pointed-set exactness, and exactness of the set truncation of a canonical fiber sequence are formalized. The remaining proof obligation is to formalize the iterated fiber sequence of a pointed map, prove the HoTT-book fiber-of-the-fiber identifications, and transport the pointed-set exactness theorem along those identifications to the homotopy-group maps. |
...
3. Formalize the iterated fiber sequence of a pointed map and prove the
   fiber-of-the-fiber identifications from HoTT book Lemma 8.4.4.
