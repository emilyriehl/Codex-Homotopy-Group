...
| Boundary maps and LES homomorphism scaffold | [`src/synthetic-homotopy-theory/long-exact-sequence-homotopy-groups.lagda.md`](src/synthetic-homotopy-theory/long-exact-sequence-homotopy-groups.lagda.md) | Defines the LES induced maps on homotopy groups of a fiber sequence, recursive boundary pointed maps, canonical iterated boundary roles, and boundary homomorphisms. It now imports standalone connecting-sequence, loop-fiber, fiber-inclusion, boundary-adapter, and set-truncated exactness modules instead of carrying those proof blocks inline. |
...
| Long exact sequence of homotopy groups | Partial, checked | The structural connecting sequence, loop-fiber equivalence, first fiber-inclusion fiber sequence, boundary-map adapters, and base set-truncated exactness package have been split into checked modules. The main LES file now owns induced homotopy-group maps, recursive boundary pointed maps, canonical iterated boundary roles, and boundary homomorphisms. The set-truncated iterated total-space theorem, canonical shifted boundary theorem, canonical boundary/fiber-inclusion theorem, direct-indexed shifted-boundary exactness theorem, reassociated public shifted-boundary exactness theorem for all indices, all-index signed looped-canonical boundary exactness theorem, canonical set-truncated LES package, and canonical-boundary group-level LES package are checked. The classifying-map fiber-sequence route is recorded as too strong in general. Remaining library-quality work is API and module-boundary cleanup, plus optional `pi_0` tail and abelian refinements. |
