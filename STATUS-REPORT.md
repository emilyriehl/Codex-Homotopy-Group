...
All three checks passed. The new package keeps the two adjacent canonical
boundary maps separate, matching the fresh-connecting-map approach and avoiding
a public recursive/canonical boundary equality.
