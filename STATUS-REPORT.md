...
- The first total-space comparison layers for the Hopf construction are now
  ...
  `join-power 2 (Fin 2) * join-power 2 (Fin 2)`. The remaining total-space
  comparison is therefore focused on associativity and join-power multiplication
  from
